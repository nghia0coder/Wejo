...
public class RabbitMQProducer : IMessageQueue, IAsyncDisposable
{
    ...
    private readonly string _queueName = QueueName.PlaypalChatMessage;

    public RabbitMQProducer(ILogger<RabbitMQProducer> logger, string queueName = QueueName.PlaypalChatMessage)
    {
